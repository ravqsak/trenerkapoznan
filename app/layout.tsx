...
export const metadata: Metadata = {
  title: {
    default: 'Aktywnie na codzień | Trener personalny kobiet Poznań',
    template: '%s | Aktywnie na codzień',
  },
  ...
  creator: 'Aktywnie na codzień',
  metadataBase: new URL('https://trenerkapoznan.pl'),
  openGraph: {
    type: 'website',
    locale: 'pl_PL',
    url: 'https://trenerkapoznan.pl',
    title: 'Aktywnie na codzień | Trener personalny kobiet Poznań',
    description: 'Trening personalny dla kobiet w Poznaniu. Naucz się ćwiczyć na siłowni bez stresu i zbuduj pewność siebie.',
    siteName: 'Aktywnie na codzień',
  },
  robots: {
    index: true,
    follow: true,
